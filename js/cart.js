...
// var deduct = document.getElementsByClassName('cart-remove')[0];
// function deduct(){
    
// };
// if(document.querySelector('.cart-remove')[0].addEventListener('click', cartCountValue--));
//update total
...
$(document).ready(function(){
    ...
    var cartCount = $('.cart-number .count');
